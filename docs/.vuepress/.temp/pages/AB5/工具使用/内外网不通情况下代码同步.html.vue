...
<img src="@source/AB5/images/工具使用/内外网不通情况下代码同步/1.png" alt="图片描述">
...
<img src="@source/AB5/images/工具使用/内外网不通情况下代码同步/4.png" alt="图片描述">
其中修改文件数是html页面中提交记录里文件的总和，如图：
<img src="@source/AB5/images/工具使用/内外网不通情况下代码同步/5.png" alt="图片描述">
可通过计算两者是否一致，来判断，导出的差量是否有缺失。
代码执行完成后会在指定目录中会生成相关文件：如图：
<img src="@source/AB5/images/工具使用/内外网不通情况下代码同步/6.png" alt="图片描述">
...
<img src="@source/AB5/images/工具使用/内外网不通情况下代码同步/7.png" alt="图片描述">
最后将合并完的代码通过git提交到项目组代码库就可以了。</li>
</ol>
<p>附件：
感兴趣的可以去doc目录下查找
<img src="@source/AB5/images/工具使用/内外网不通情况下代码同步/8.png" alt="图片描述">

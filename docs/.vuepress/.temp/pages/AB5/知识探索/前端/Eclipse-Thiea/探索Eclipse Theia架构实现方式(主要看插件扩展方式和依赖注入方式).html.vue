...
<p><img src="@source/AB5/images/知识探索/前端/Eclipse-Thiea/探索Eclipse Theia架构实现方式(主要看插件扩展方式和依赖注入方式)/1.png" alt="enter image description here"></p>
...
<span class="line">      }</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/AB5/images/知识探索/前端/Eclipse-Thiea/探索Eclipse Theia架构实现方式(主要看插件扩展方式和依赖注入方式)/2.png" alt="enter image description here">
<img src="@source/AB5/images/知识探索/前端/Eclipse-Thiea/探索Eclipse Theia架构实现方式(主要看插件扩展方式和依赖注入方式)/3.png" alt="enter image description here"></p>
...
<p>其他模块同理
<img src="@source/AB5/images/知识探索/前端/Eclipse-Thiea/探索Eclipse Theia架构实现方式(主要看插件扩展方式和依赖注入方式)/4.png" alt="图片描述"></p>

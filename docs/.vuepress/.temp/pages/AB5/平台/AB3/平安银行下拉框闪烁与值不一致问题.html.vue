...
<img src="@source/AB5/images/平台/AB3/平安银行下拉框闪烁与值不一致问题/1.png" alt="undefined"></p>
...
<img src="@source/AB5/images/平台/AB3/平安银行下拉框闪烁与值不一致问题/2.png" alt="undefined">
<img src="@source/AB5/images/平台/AB3/平安银行下拉框闪烁与值不一致问题/3.png" alt="undefined">
<img src="@source/AB5/images/平台/AB3/平安银行下拉框闪烁与值不一致问题/4.png" alt="undefined">
<img src="@source/AB5/images/平台/AB3/平安银行下拉框闪烁与值不一致问题/5.png" alt="undefined">
通过以下简单交易可以重现该问题
<img src="@source/AB5/images/平台/AB3/平安银行下拉框闪烁与值不一致问题/6.png" alt="undefined">
<img src="@source/AB5/images/平台/AB3/平安银行下拉框闪烁与值不一致问题/7.png" alt="undefined"></p>
...
<img src="@source/AB5/images/平台/AB3/平安银行下拉框闪烁与值不一致问题/8.png" alt="undefined"></p>
...
<img src="@source/AB5/images/平台/AB3/平安银行下拉框闪烁与值不一致问题/9.png" alt="undefined"></p>
...
<img src="@source/AB5/images/平台/AB3/平安银行下拉框闪烁与值不一致问题/10.png" alt="undefined">
<img src="@source/AB5/images/平台/AB3/平安银行下拉框闪烁与值不一致问题/11.png" alt="undefined"></p>
...
<img src="@source/AB5/images/平台/AB3/平安银行下拉框闪烁与值不一致问题/12.png" alt="undefined">
下拉列表正常收回时，可以看到有 modify 事件触发
<img src="@source/AB5/images/平台/AB3/平安银行下拉框闪烁与值不一致问题/13.png" alt="undefined">
<img src="@source/AB5/images/平台/AB3/平安银行下拉框闪烁与值不一致问题/14.png" alt="undefined">
下拉列表在交易繁忙时收回，可以看到未触发 modify 事件，未同步值到 model
<img src="@source/AB5/images/平台/AB3/平安银行下拉框闪烁与值不一致问题/15.png" alt="undefined">
去除全局的 busyfilter 后
会出现值的修改在 onselectionchange 后触发，onselectionchange 事件当次取值是旧值，下一次再取值是新值的情况
<img src="@source/AB5/images/平台/AB3/平安银行下拉框闪烁与值不一致问题/16.png" alt="undefined">

...
<p>⑴解释执行：
<img src="@source/AB5/images/平台/AB4/运行时/MVEL编译执行技术验证/1.png" alt="图片描述"></p>
<p>⑵基于模板：
<img src="@source/AB5/images/平台/AB4/运行时/MVEL编译执行技术验证/2.png" alt="图片描述"></p>
<p>⑶预编译执行：
<img src="@source/AB5/images/平台/AB4/运行时/MVEL编译执行技术验证/3.png" alt="图片描述"></p>
...
<img src="@source/AB5/images/平台/AB4/运行时/MVEL编译执行技术验证/4.png" alt="图片描述"></p>
<p><img src="@source/AB5/images/平台/AB4/运行时/MVEL编译执行技术验证/5.png" alt="图片描述"></p>
...
<img src="@source/AB5/images/平台/AB4/运行时/MVEL编译执行技术验证/6.png" alt="图片描述"></p>
<p><img src="@source/AB5/images/平台/AB4/运行时/MVEL编译执行技术验证/7.png" alt="图片描述"></p>
<p><img src="@source/AB5/images/平台/AB4/运行时/MVEL编译执行技术验证/8.png" alt="图片描述"></p>
...
<p><img src="@source/AB5/images/平台/AB4/运行时/MVEL编译执行技术验证/9.png" alt="图片描述"></p>
<p>编译执行时一次编译与多次编译性能对比</p>
<p>||执行次数||50||150||500||1000||10000||100000||1000000||10000000||
||每次编译||104||120||340||577||4443||42829||||||
||一次编译||65||64||67||71||76||126||594||5473||</p>
<p><img src="@source/AB5/images/平台/AB4/运行时/MVEL编译执行技术验证/10.png" alt="图片描述"></p>
...
<p><img src="@source/AB5/images/平台/AB4/运行时/MVEL编译执行技术验证/11.png" alt="图片描述"></p>
...
<img src="@source/AB5/images/平台/AB4/运行时/MVEL编译执行技术验证/12.png" alt="图片描述"></p>
<p><img src="@source/AB5/images/平台/AB4/运行时/MVEL编译执行技术验证/13.png" alt="图片描述"></p>
<p>已解决问题：
  a循环次数超过51次时异常；

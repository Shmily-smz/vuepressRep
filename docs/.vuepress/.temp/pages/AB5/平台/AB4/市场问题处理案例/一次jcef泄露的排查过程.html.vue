...
<img src="@source/AB5/images/平台/AB4/市场问题处理案例/一次jcef泄露的排查过程/1.png" alt="图片描述">
<img src="@source/AB5/images/平台/AB4/市场问题处理案例/一次jcef泄露的排查过程/2.png" alt="图片描述">
<img src="@source/AB5/images/平台/AB4/市场问题处理案例/一次jcef泄露的排查过程/3.png" alt="图片描述">
可以看出mat中显示的可能为内存泄露的对象有三个，其中两个线程，一个org.tukaani.xz包中的对象，代发工资中用到xz方式压缩文件，而且该对象中有些是可以回收的，暂时先不管。</p>
<p>打开两个线程对其他对象的引用关系
<img src="@source/AB5/images/平台/AB4/市场问题处理案例/一次jcef泄露的排查过程/4.png" alt="图片描述">
<img src="@source/AB5/images/平台/AB4/市场问题处理案例/一次jcef泄露的排查过程/5.png" alt="图片描述">
...
<img src="@source/AB5/images/平台/AB4/市场问题处理案例/一次jcef泄露的排查过程/6.png" alt="图片描述">
<img src="@source/AB5/images/平台/AB4/市场问题处理案例/一次jcef泄露的排查过程/7.png" alt="图片描述">
想到abc中内嵌cef时，是使用java调用jcef方式进行的，而且是通过jni方式，目前为止，问题已经初步定位到是这种调用时，没有释放对象导致。</p>
<p>搜jcef调用相关内存泄露信息，看到如下链接
<img src="@source/AB5/images/平台/AB4/市场问题处理案例/一次jcef泄露的排查过程/8.png" alt="图片描述">
<img src="@source/AB5/images/平台/AB4/市场问题处理案例/一次jcef泄露的排查过程/9.png" alt="图片描述"></p>
<p><img src="@source/AB5/images/平台/AB4/市场问题处理案例/一次jcef泄露的排查过程/10.png" alt="图片描述">
<img src="@source/AB5/images/平台/AB4/市场问题处理案例/一次jcef泄露的排查过程/11.png" alt="图片描述">
...
<img src="@source/AB5/images/平台/AB4/市场问题处理案例/一次jcef泄露的排查过程/12.png" alt="图片描述">
取dump分析(如下图：大量的JNI Local类型对象，可确定问题已重现)
<img src="@source/AB5/images/平台/AB4/市场问题处理案例/一次jcef泄露的排查过程/13.png" alt="图片描述"></p>

...
![undefined<img src="@source/AB5/images/平台/AB4/市场问题处理案例/吉林农信元空间OOM案例分析/1.png" alt="013.png014.png013.png">](file://D:/Desktop/OOM%E6%A1%88%E4%BE%8B/picture/013.png?lastModify=1654505682)
...
混合回收图示:
![undefined<img src="@source/AB5/images/平台/AB4/市场问题处理案例/吉林农信元空间OOM案例分析/2.png" alt="014.png">](file://D:/Desktop/OOM%E6%A1%88%E4%BE%8B/picture/014.png?lastModify=1654505682)
...
以下是部分日志截取
![undefined<img src="@source/AB5/images/平台/AB4/市场问题处理案例/吉林农信元空间OOM案例分析/3.png" alt="001.png">](file://D:/Desktop/OOM%E6%A1%88%E4%BE%8B/picture/001.png?lastModify=1654505682)
日志内容介绍</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>![undefined<img src="@source/AB5/images/平台/AB4/市场问题处理案例/吉林农信元空间OOM案例分析/5.jpg" alt="002.jpeg">](file://D:/Desktop/OOM%E6%A1%88%E4%BE%8B/picture/002.jpeg?lastModify=1654505682)</p>
...
<p>mat的内存报告
![undefined<img src="@source/AB5/images/平台/AB4/市场问题处理案例/吉林农信元空间OOM案例分析/6.png" alt="003.png">](file://D:/Desktop/OOM%E6%A1%88%E4%BE%8B/picture/003.png?lastModify=1654505682)
URLClassLoader 实例137个占据 71.23%的内存 显然不对</p>
<p>mat内存直方图
![undefined<img src="@source/AB5/images/平台/AB4/市场问题处理案例/吉林农信元空间OOM案例分析/7.png" alt="004.png">](file://D:/Desktop/OOM%E6%A1%88%E4%BE%8B/picture/004.png?lastModify=1654505682)</p>
...
![undefined<img src="@source/AB5/images/平台/AB4/市场问题处理案例/吉林农信元空间OOM案例分析/8.png" alt="005.png">](file://D:/Desktop/OOM%E6%A1%88%E4%BE%8B/picture/005.png?lastModify=1654505682)
...
![undefined<img src="@source/AB5/images/平台/AB4/市场问题处理案例/吉林农信元空间OOM案例分析/9.png" alt="009.png">](file://D:/Desktop/OOM%E6%A1%88%E4%BE%8B/picture/009.png?lastModify=1654505682)
旧实例加载的类实例缓存集合map, 在watchService监听下也会被清理，这些类也会被卸载（类卸载条件文末给出）</p>
<p>![undefined<img src="@source/AB5/images/平台/AB4/市场问题处理案例/吉林农信元空间OOM案例分析/10.png" alt="010.png">](file://D:/Desktop/OOM%E6%A1%88%E4%BE%8B/picture/010.png?lastModify=1654505682)</p>
<p>![undefined<img src="@source/AB5/images/平台/AB4/市场问题处理案例/吉林农信元空间OOM案例分析/11.png" alt="011.png">](file://D:/Desktop/OOM%E6%A1%88%E4%BE%8B/picture/011.png?lastModify=1654505682)
...
![undefined<img src="@source/AB5/images/平台/AB4/市场问题处理案例/吉林农信元空间OOM案例分析/12.png" alt="006.png">](file://D:/Desktop/OOM%E6%A1%88%E4%BE%8B/picture/006.png?lastModify=1654505682)</p>
<p>![undefined<img src="@source/AB5/images/平台/AB4/市场问题处理案例/吉林农信元空间OOM案例分析/13.png" alt="007.png">](file://D:/Desktop/OOM%E6%A1%88%E4%BE%8B/picture/007.png?lastModify=1654505682)
![undefined<img src="@source/AB5/images/平台/AB4/市场问题处理案例/吉林农信元空间OOM案例分析/14.png" alt="019.png">](file://D:/Desktop/OOM%E6%A1%88%E4%BE%8B/picture/019.png?lastModify=1654505682)</p>
<p>URLClassLoader实例 只有 FileWatchdog 线程持有 此线程由 log4j中的PropertyWatchdog创建，代码如下
![undefined<img src="@source/AB5/images/平台/AB4/市场问题处理案例/吉林农信元空间OOM案例分析/15.png" alt="008.png">](file://D:/Desktop/OOM%E6%A1%88%E4%BE%8B/picture/008.png?lastModify=1654505682)
此线程为守护线程，应用进程还在就一直存在。
![undefined<img src="@source/AB5/images/平台/AB4/市场问题处理案例/吉林农信元空间OOM案例分析/16.png" alt="022.png">](file://D:/Desktop/OOM%E6%A1%88%E4%BE%8B/picture/022.png?lastModify=1654505682)
...
![undefined<img src="@source/AB5/images/平台/AB4/市场问题处理案例/吉林农信元空间OOM案例分析/17.png" alt="016.png">](file://D:/Desktop/OOM%E6%A1%88%E4%BE%8B/picture/016.png?lastModify=1654505682)
![undefined<img src="@source/AB5/images/平台/AB4/市场问题处理案例/吉林农信元空间OOM案例分析/18.png" alt="017.png">](file://D:/Desktop/OOM%E6%A1%88%E4%BE%8B/picture/017.png?lastModify=1654505682)
...
2、热部署重新加载类后 stop线程
![undefined<img src="@source/AB5/images/平台/AB4/市场问题处理案例/吉林农信元空间OOM案例分析/19.png" alt="012.png">](file://D:/Desktop/OOM%E6%A1%88%E4%BE%8B/picture/012.png?lastModify=1654505682)</p>

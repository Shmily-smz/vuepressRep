...
<p><img src="@source/AB5/images/平台/AB4/UI界面/AB内嵌Ocx控件方案/1.png" alt="图片描述">
...
<img src="@source/AB5/images/平台/AB4/UI界面/AB内嵌Ocx控件方案/2.png" alt="图片描述">
图3.2  abc有界面和无界面内嵌OleManager.exe
（1） 有界面内嵌：
首先需要启动exe，初始化ocx服务。建立ABC第一进程Socket服务，获取第一进<br>
<img src="@source/AB5/images/平台/AB4/UI界面/AB内嵌Ocx控件方案/3.png" alt="图片描述">
图3.3 有界面内嵌exe启动过程
...
<img src="@source/AB5/images/平台/AB4/UI界面/AB内嵌Ocx控件方案/4.png" alt="图片描述">
图3.4 无界面内嵌exe调用过程

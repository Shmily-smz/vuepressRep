...
<p>测试代码为
<img src="@source/AB产品知识库20240403/images/知识探索/后端/文件存在，但file.exists返回false问题/1.png" alt="图片描述"></p>
<p>对代码中调用的方法进行分析
<img src="@source/AB产品知识库20240403/images/知识探索/后端/文件存在，但file.exists返回false问题/2.png" alt="图片描述">
...
<img src="@source/AB产品知识库20240403/images/知识探索/后端/文件存在，但file.exists返回false问题/3.png" alt="图片描述">
...
<img src="@source/AB产品知识库20240403/images/知识探索/后端/文件存在，但file.exists返回false问题/4.png" alt="图片描述">
简而言之就是，Path 用于来表示文件路径和文件，那用 Path 修改环境变量后有没有同样的问题呢，上测试代码：
<img src="@source/AB产品知识库20240403/images/知识探索/后端/文件存在，但file.exists返回false问题/5.png" alt="图片描述">

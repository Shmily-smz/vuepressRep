...
<img src="@source/AB产品知识库20240403/images/平台/AB4/运行时/watchservice资源监听优化/1.png" alt="图片描述"></p>
<p><strong>简单来说：</strong>
程序先注册将要接受监听的文件夹，当文件夹下内容发生改变时，操作系统会主动产生相关事件，程序接受到事件后，对改变的文件进行更新。</p>
<p><strong>代码实现为</strong>  <strong>：</strong>
1、创建WatchService
<img src="@source/AB产品知识库20240403/images/平台/AB4/运行时/watchservice资源监听优化/2.png" alt="图片描述">
2、把文件夹注册监听
<img src="@source/AB产品知识库20240403/images/平台/AB4/运行时/watchservice资源监听优化/3.png" alt="图片描述">
3、循环获取改变事件
<img src="@source/AB产品知识库20240403/images/平台/AB4/运行时/watchservice资源监听优化/4.png" alt="图片描述">
...
<img src="@source/AB产品知识库20240403/images/平台/AB4/运行时/watchservice资源监听优化/5.png" alt="图片描述">
...
<img src="@source/AB产品知识库20240403/images/平台/AB4/运行时/watchservice资源监听优化/6.png" alt="图片描述">
...
<img src="@source/AB产品知识库20240403/images/平台/AB4/运行时/watchservice资源监听优化/7.png" alt="图片描述"></p>
...
<img src="@source/AB产品知识库20240403/images/平台/AB4/运行时/watchservice资源监听优化/8.png" alt="图片描述">
查看JDK源码，可以看到重复注册会替换原有的注册，那么此次问题处理可以分为两步：
1、 重新把文件系统进行注册。
2、 把文件系统中的文件全部作为修改发送到GRM中进行刷新。
实现代码如下
<img src="@source/AB产品知识库20240403/images/平台/AB4/运行时/watchservice资源监听优化/9.png" alt="图片描述">
...
<img src="@source/AB产品知识库20240403/images/平台/AB4/运行时/watchservice资源监听优化/10.png" alt="图片描述">)
补充:

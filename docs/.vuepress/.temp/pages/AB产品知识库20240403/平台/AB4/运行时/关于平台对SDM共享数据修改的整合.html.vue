...
<img src="@source/AB产品知识库20240403/images/平台/AB4/运行时/关于平台对SDM共享数据修改的整合/1.png" alt="图片描述">
在这里我们就可以对共享数据的修改操作进行过滤，并抛出异常让开发人员知道：
<img src="@source/AB产品知识库20240403/images/平台/AB4/运行时/关于平台对SDM共享数据修改的整合/2.png" alt="图片描述"></p>
...
<img src="@source/AB产品知识库20240403/images/平台/AB4/运行时/关于平台对SDM共享数据修改的整合/3.png" alt="图片描述">

...
<img src="@source/AB产品知识库20240403/images/平台/AB4/市场问题处理案例/abc启动无界面案例分析/1.png" alt="图片描述">
...
<img src="@source/AB产品知识库20240403/images/平台/AB4/市场问题处理案例/abc启动无界面案例分析/2.png" alt="图片描述">
<img src="@source/AB产品知识库20240403/images/平台/AB4/市场问题处理案例/abc启动无界面案例分析/3.png" alt="图片描述">
发现该线阻塞在macutil.java 173行，查看源代码：
<img src="@source/AB产品知识库20240403/images/平台/AB4/市场问题处理案例/abc启动无界面案例分析/4.png" alt="图片描述">
发现在调用ipconfig命令，获取本地的mac地址，没有返回，读取io流阻塞。
针对现象2：
经过查看任务管理器，查看内存停止到173M，并且不再增长。
<img src="@source/AB产品知识库20240403/images/平台/AB4/市场问题处理案例/abc启动无界面案例分析/5.png" alt="图片描述">
查看日志，发现abc启动后，只有gc日志，没有其他日志，所以判定开始启动的时候就已经在某个地方发生阻塞，同样抓取线程dump（见附件现象2.tdump）
<img src="@source/AB产品知识库20240403/images/平台/AB4/市场问题处理案例/abc启动无界面案例分析/6.png" alt="图片描述">
因为很多东西还没有启动，所以线程较少，且无明显死锁行为。
<img src="@source/AB产品知识库20240403/images/平台/AB4/市场问题处理案例/abc启动无界面案例分析/7.png" alt="图片描述">
<img src="@source/AB产品知识库20240403/images/平台/AB4/市场问题处理案例/abc启动无界面案例分析/8.png" alt="图片描述">
经过看具体的线程信息，发现main线程阻塞在了ABCApplication.java:940行，查看源代码
<img src="@source/AB产品知识库20240403/images/平台/AB4/市场问题处理案例/abc启动无界面案例分析/9.png" alt="图片描述">
...
<p>感兴趣的自行去doc目录下寻找
<img src="@source/AB产品知识库20240403/images/平台/AB4/市场问题处理案例/abc启动无界面案例分析/10.png" alt="图片描述"></p>
</div></template>

...
<img src="@source/AB3/images/平台/AB4/UI界面/Adore2 html5资源的编译利用gulp整合的说明/1.png" alt="图片描述">
对比原css编译任务,可见新增的css-cdns只是指定了另一目标对象(src中指定)并进行了重命名而已.
<img src="@source/AB3/images/平台/AB4/UI界面/Adore2 html5资源的编译利用gulp整合的说明/2.png" alt="图片描述"></p>

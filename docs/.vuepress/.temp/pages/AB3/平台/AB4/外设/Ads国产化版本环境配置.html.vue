...
<p>error while loading shared libraries: liblog4cplus-1.2.so.5: cannot open shared object file: No such file or directory<img src="@source/AB3/images/平台/AB4/外设/Ads国产化版本环境配置/1.png" alt="enter image description here"></p>
<h4 id="_3-权限问题" tabindex="-1"><a class="header-anchor" href="#_3-权限问题"><span>3.权限问题:</span></a></h4>
<p><img src="@source/AB3/images/平台/AB4/外设/Ads国产化版本环境配置/2.png" alt="VirtualBox_QtCreat_03_06_2021_17_07_23.png"></p>
...
<p>ldd Ads
<img src="@source/AB3/images/平台/AB4/外设/Ads国产化版本环境配置/3.png" alt="VirtualBox_QtCreat_04_06_2021_15_19_50.png">
...
<img src="@source/AB3/images/平台/AB4/外设/Ads国产化版本环境配置/4.png" alt="enter image description here"></p>

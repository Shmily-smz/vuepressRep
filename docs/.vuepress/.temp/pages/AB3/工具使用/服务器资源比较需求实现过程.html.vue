...
<img src="@source/AB3/images/工具使用/服务器资源比较需求实现过程/1.png" alt="图片描述">
2.convertDLFileToMap方法是从服务器上下载数据
<img src="@source/AB3/images/工具使用/服务器资源比较需求实现过程/2.png" alt="图片描述">
3. 两种比较方法多余和不同：因为数据都是以MAP形式存储，所以在进行多余比较时将两个MAP中KEY值相同的去掉，剩下的就是多出来的；而不同的比较是比较KEY值相同Value不同。
<img src="@source/AB3/images/工具使用/服务器资源比较需求实现过程/3.png" alt="图片描述">
<img src="@source/AB3/images/工具使用/服务器资源比较需求实现过程/4.png" alt="图片描述">
4.通过两次多余部分比较分别得出两个服务器之间各自的增多和缺失的资源
<img src="@source/AB3/images/工具使用/服务器资源比较需求实现过程/5.png" alt="图片描述"></p>
...
<img src="@source/AB3/images/工具使用/服务器资源比较需求实现过程/6.png" alt="图片描述">
将需要比较的分类及其下载路径存入MAP中，通过FOR循环分别下载数据进行比较
<img src="@source/AB3/images/工具使用/服务器资源比较需求实现过程/7.png" alt="图片描述">
比较是采用两个FOR循环，第一个循环是根据服务器的个数作为N，然后在对每个服务器的资源分类循环下载并比较。
<img src="@source/AB3/images/工具使用/服务器资源比较需求实现过程/8.png" alt="图片描述">
通过传给outputFileMap方法的mvalue值进行判断下载。
<img src="@source/AB3/images/工具使用/服务器资源比较需求实现过程/9.png" alt="图片描述">
...
<img src="@source/AB3/images/工具使用/服务器资源比较需求实现过程/10.png" alt="图片描述">
...
<img src="@source/AB3/images/工具使用/服务器资源比较需求实现过程/11.png" alt="图片描述"></p>

...
<img src="@source/AB产品知识库/images/工具使用/ABS抓包加密验证/1.jpg" alt="图片描述"></p>
<p>添加过滤条件，此处过滤条件为 tcp.port==50001（abs 通讯端口为 50001，实际根据本地配置）。
<img src="@source/AB产品知识库/images/工具使用/ABS抓包加密验证/2.jpg" alt="图片描述"></p>
<p>开始抓包。
<img src="@source/AB产品知识库/images/工具使用/ABS抓包加密验证/3.jpg" alt="图片描述"></p>
<p>ABC 向 ABS 发送请求。
      此时抓包界面会出现最新的请求信息，点击选中，右键点击追踪流，即可查看本次请求或响应的相关数据。
<img src="@source/AB产品知识库/images/工具使用/ABS抓包加密验证/4.jpg" alt="图片描述"></p>
...
<img src="@source/AB产品知识库/images/工具使用/ABS抓包加密验证/5.jpg" alt="图片描述"></p>
...
<img src="@source/AB产品知识库/images/工具使用/ABS抓包加密验证/6.jpg" alt="图片描述"></p>
</div></template>

...
<img src="@source/AB产品知识库/images/平台/AB4/运行时/AB4.X控制流程节点执行次数/1.png" alt="图片描述">
...
<img src="@source/AB产品知识库/images/平台/AB4/运行时/AB4.X控制流程节点执行次数/2.png" alt="图片描述">
<img src="@source/AB产品知识库/images/平台/AB4/运行时/AB4.X控制流程节点执行次数/3.png" alt="图片描述">
...
<img src="@source/AB产品知识库/images/平台/AB4/运行时/AB4.X控制流程节点执行次数/4.png" alt="图片描述">
<img src="@source/AB产品知识库/images/平台/AB4/运行时/AB4.X控制流程节点执行次数/5.png" alt="图片描述">
现在没有将服务端和客户端运行的数量进行合并，只是做了单独的计数，所以在服务端需要执行逻辑前，将节点执行次数重置为 0，如下图：
<img src="@source/AB产品知识库/images/平台/AB4/运行时/AB4.X控制流程节点执行次数/6.png" alt="图片描述">
<img src="@source/AB产品知识库/images/平台/AB4/运行时/AB4.X控制流程节点执行次数/7.png" alt="图片描述">
<img src="@source/AB产品知识库/images/平台/AB4/运行时/AB4.X控制流程节点执行次数/8.png" alt="图片描述"></p>
...
<img src="@source/AB产品知识库/images/平台/AB4/运行时/AB4.X控制流程节点执行次数/9.png" alt="图片描述">
<img src="@source/AB产品知识库/images/平台/AB4/运行时/AB4.X控制流程节点执行次数/10.png" alt="图片描述">
并且在执行次数超过我们设置的警告次数时，在日志中也会打印警告日志。
<img src="@source/AB产品知识库/images/平台/AB4/运行时/AB4.X控制流程节点执行次数/11.png" alt="图片描述"></p>

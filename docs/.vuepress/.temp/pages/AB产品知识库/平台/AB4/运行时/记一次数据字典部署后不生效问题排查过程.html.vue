...
<img src="@source/AB产品知识库/images/平台/AB4/运行时/记一次数据字典部署后不生效问题排查过程/1.png" alt="图片描述">
但交易中偶发还会报出如下错误
<img src="@source/AB产品知识库/images/平台/AB4/运行时/记一次数据字典部署后不生效问题排查过程/2.png" alt="图片描述"></p>
...
<img src="@source/AB产品知识库/images/平台/AB4/运行时/记一次数据字典部署后不生效问题排查过程/3.png" alt="图片描述">
那么在ADERegistry的构造方法中，增加调用堆栈打印，看新对象是怎么产生的
<img src="@source/AB产品知识库/images/平台/AB4/运行时/记一次数据字典部署后不生效问题排查过程/4.png" alt="图片描述"></p>
<p>通过日志可以看到，新对象是在从context中获取ADERegistry时被实例化出来的
<img src="@source/AB产品知识库/images/平台/AB4/运行时/记一次数据字典部署后不生效问题排查过程/5.png" alt="图片描述"></p>
<p>跟踪下相关实例化条件代码
<img src="@source/AB产品知识库/images/平台/AB4/运行时/记一次数据字典部署后不生效问题排查过程/6.png" alt="图片描述">
<img src="@source/AB产品知识库/images/平台/AB4/运行时/记一次数据字典部署后不生效问题排查过程/7.png" alt="图片描述">
...
<img src="@source/AB产品知识库/images/平台/AB4/运行时/记一次数据字典部署后不生效问题排查过程/8.png" alt="图片描述"></p>
<p>为了验证想法是否正确。调小内存大小，gc增加时间打印。
<img src="@source/AB产品知识库/images/平台/AB4/运行时/记一次数据字典部署后不生效问题排查过程/9.png" alt="图片描述"></p>
...
<img src="@source/AB产品知识库/images/平台/AB4/运行时/记一次数据字典部署后不生效问题排查过程/10.png" alt="图片描述">
<img src="@source/AB产品知识库/images/平台/AB4/运行时/记一次数据字典部署后不生效问题排查过程/11.png" alt="图片描述">
...
<p><img src="@source/AB产品知识库/images/平台/AB4/运行时/记一次数据字典部署后不生效问题排查过程/12.png" alt="图片描述"><img src="@source/AB产品知识库/images/平台/AB4/运行时/记一次数据字典部署后不生效问题排查过程/13.png" alt="图片描述">
...
<p><img src="@source/AB产品知识库/images/平台/AB4/运行时/记一次数据字典部署后不生效问题排查过程/14.png" alt="图片描述">
<img src="@source/AB产品知识库/images/平台/AB4/运行时/记一次数据字典部署后不生效问题排查过程/15.png" alt="图片描述"></p>
...
<img src="@source/AB产品知识库/images/平台/AB4/运行时/记一次数据字典部署后不生效问题排查过程/16.png" alt="图片描述">
<img src="@source/AB产品知识库/images/平台/AB4/运行时/记一次数据字典部署后不生效问题排查过程/17.png" alt="图片描述"></p>
...
<p><img src="@source/AB产品知识库/images/平台/AB4/运行时/记一次数据字典部署后不生效问题排查过程/18.png" alt="图片描述">

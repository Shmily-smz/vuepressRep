...
<img src="@source/AB产品知识库/images/平台/AB4/UI界面/自定义UI组件的使用和参数导出/1.png" alt="图片描述">
<img src="@source/AB产品知识库/images/平台/AB4/UI界面/自定义UI组件的使用和参数导出/2.png" alt="图片描述"></p>
...
<img src="@source/AB产品知识库/images/平台/AB4/UI界面/自定义UI组件的使用和参数导出/3.png" alt="图片描述"></p>
...
<img src="@source/AB产品知识库/images/平台/AB4/UI界面/自定义UI组件的使用和参数导出/4.png" alt="图片描述"></p>
...
<img src="@source/AB产品知识库/images/平台/AB4/UI界面/自定义UI组件的使用和参数导出/5.png" alt="图片描述">
<img src="@source/AB产品知识库/images/平台/AB4/UI界面/自定义UI组件的使用和参数导出/6.png" alt="图片描述"></p>
...
<span class="line">}</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/AB产品知识库/images/平台/AB4/UI界面/自定义UI组件的使用和参数导出/7.png" alt="图片描述">
...
<img src="@source/AB产品知识库/images/平台/AB4/UI界面/自定义UI组件的使用和参数导出/8.png" alt="图片描述">
<img src="@source/AB产品知识库/images/平台/AB4/UI界面/自定义UI组件的使用和参数导出/9.png" alt="图片描述"></li>
<li>重新在ide中打开abf4a文件，在视图的左侧就会有”自定义组件”，如下图
<img src="@source/AB产品知识库/images/平台/AB4/UI界面/自定义UI组件的使用和参数导出/10.png" alt="图片描述"></li>
<li>当你从左侧拖动自定义组件到右侧时，组件的相关属性和事件也都可以进行可视化编辑，如下图：
<img src="@source/AB产品知识库/images/平台/AB4/UI界面/自定义UI组件的使用和参数导出/11.png" alt="图片描述">
<img src="@source/AB产品知识库/images/平台/AB4/UI界面/自定义UI组件的使用和参数导出/12.png" alt="图片描述">
...
<span class="line">}</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/AB产品知识库/images/平台/AB4/UI界面/自定义UI组件的使用和参数导出/13.png" alt="图片描述">
<img src="@source/AB产品知识库/images/平台/AB4/UI界面/自定义UI组件的使用和参数导出/14.png" alt="图片描述">

...
<img src="@source/allmd/images/待评审文档/陕西信合ABC白屏概要分析/1.png" alt="image-20230110185720742" style="zoom: 67%;" />
...
<p><img src="@source/allmd/images/待评审文档/陕西信合ABC白屏概要分析/2.png" alt="Image"></p>
<p><img src="@source/allmd/images/待评审文档/陕西信合ABC白屏概要分析/3.png" alt="Image"></p>
<p><strong>带着这样的思考，对错误模块KERNELBASE.dll，查询资料检索：</strong></p>
<p>https://github.com/electron/electron/issues/36841</p>
<p><img src="@source/allmd/images/待评审文档/陕西信合ABC白屏概要分析/4.png" alt="image-20230110204428955"></p>
<p>https://github.com/cefsharp/CefSharp/issues/2019</p>
<p>Sharp版的cef也有类似的问题，通过调试日志，查找到是内存溢出导致的问题</p>
<p><img src="@source/allmd/images/待评审文档/陕西信合ABC白屏概要分析/5.png" alt="image-20230110152422967"></p>
<p><img src="@source/allmd/images/待评审文档/陕西信合ABC白屏概要分析/6.png" alt="image-20230110152447040"></p>
<p>那么KERNELBASE.dll的本质是什么呢？继续检索资料</p>
<p>https://zhuanlan.zhihu.com/p/242615448</p>
<img src="@source/allmd/images/待评审文档/陕西信合ABC白屏概要分析/7.png" alt="image-20230110204100973" style="zoom:80%;" />
<img src="@source/allmd/images/待评审文档/陕西信合ABC白屏概要分析/8.png" alt="image-20230110204113211" style="zoom: 67%;" />
...
<p><img src="@source/allmd/images/待评审文档/陕西信合ABC白屏概要分析/9.png" alt="image-20230111090425287"></p>
<p><img src="@source/allmd/images/待评审文档/陕西信合ABC白屏概要分析/10.png" alt="image-20230111090508593"></p>
...
<p><img src="@source/allmd/images/待评审文档/陕西信合ABC白屏概要分析/11.png" alt="image-20230110154611362"></p>
<p><img src="@source/allmd/images/待评审文档/陕西信合ABC白屏概要分析/12.png" alt="image-20230110154623284"></p>
<p>https://magpcss.org/ceforum/viewtopic.php?f=17&amp;t=18019&amp;p=47458&amp;hilit=0xe0000008#p47458</p>
<p><img src="@source/allmd/images/待评审文档/陕西信合ABC白屏概要分析/13.png" alt="image-20230110151305654"></p>
<p>https://superuser.com/questions/1442974/chrome-the-exception-unknown-software-exception-0xe0000008</p>
<p><img src="@source/allmd/images/待评审文档/陕西信合ABC白屏概要分析/14.png" alt="image-20230110154909830"></p>

...
<img src="@source/allmd/images/平台/AB4/操作系统/abc迁移到Linux下运行的问题和解决方案/1.png" alt="图片描述">
...
<img src="@source/allmd/images/平台/AB4/操作系统/abc迁移到Linux下运行的问题和解决方案/2.png" alt="图片描述">
<img src="@source/allmd/images/平台/AB4/操作系统/abc迁移到Linux下运行的问题和解决方案/3.png" alt="图片描述">
...
<img src="@source/allmd/images/平台/AB4/操作系统/abc迁移到Linux下运行的问题和解决方案/4.png" alt="图片描述">
类似的问题还有在从jar包中拷贝Ads到ads文件夹后仍无法正常启动ads，这也是因为新拷贝出来的Ads并没有执行的权限，于是加入setExecute(true)，问题解决。
<img src="@source/allmd/images/平台/AB4/操作系统/abc迁移到Linux下运行的问题和解决方案/5.png" alt="图片描述"></p>

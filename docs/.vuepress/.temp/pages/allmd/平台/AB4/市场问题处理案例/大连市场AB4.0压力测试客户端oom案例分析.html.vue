...
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/大连市场AB4.0压力测试客户端oom案例分析/1.png" alt="图片描述">
...
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/大连市场AB4.0压力测试客户端oom案例分析/2.png" alt="图片描述">
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/大连市场AB4.0压力测试客户端oom案例分析/3.png" alt="图片描述">
有图中可以看到主要是SocketSessionImpl这个类对象占用了大量的内存，查看一下这个类：
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/大连市场AB4.0压力测试客户端oom案例分析/4.png" alt="图片描述">
可以看到这个类的对象有220个，并且每一个对象约有1.6m，总大小220*1.6=352这个已经超出我们的预期。看一下有那个类引用了这个对象：
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/大连市场AB4.0压力测试客户端oom案例分析/5.png" alt="图片描述">
由图中可以看到CsvClientMQChannel这个引用几乎占用了整个对象空间。看一下有多少个这样的对象：
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/大连市场AB4.0压力测试客户端oom案例分析/6.png" alt="图片描述">
由图中可以看到仍然有220个对象，结合压力测试插件的源码，此类的对象是由TcpVirtualTeller类中init()方法创建的：
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/大连市场AB4.0压力测试客户端oom案例分析/7.png" alt="图片描述">
这个TcpVirtualTeller应该是脚本中调用的，并且和CsvClientMQChannel应该是1:1的，在看一下有多少个TcpVirtualTeller对象：
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/大连市场AB4.0压力测试客户端oom案例分析/8.png" alt="图片描述">
...
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/大连市场AB4.0压力测试客户端oom案例分析/9.png" alt="图片描述">
...
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/大连市场AB4.0压力测试客户端oom案例分析/10.png" alt="图片描述"></p>

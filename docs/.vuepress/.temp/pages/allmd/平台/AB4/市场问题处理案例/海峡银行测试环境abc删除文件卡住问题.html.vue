...
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/海峡银行测试环境abc删除文件卡住问题/1.png" alt="enter image description here">
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/海峡银行测试环境abc删除文件卡住问题/2.png" alt="enter image description here">
查看jdk源码，发现这是个native方法，而且此方法在java中使用频率非常高。猜测很可能是系统文件系统出现了问题
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/海峡银行测试环境abc删除文件卡住问题/3.png" alt="enter image description here"></p>

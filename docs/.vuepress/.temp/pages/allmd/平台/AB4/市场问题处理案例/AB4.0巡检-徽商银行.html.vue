...
<p>ABS 巡检清单 1
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/1.png" alt="图片描述">
ABS 巡检清单 2
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/2.png" alt="图片描述">
ABS 巡检清单 3
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/3.png" alt="图片描述">
ABC 巡检清单 1
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/4.png" alt="图片描述">
ABC 巡检清单 2
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/5.png" alt="图片描述">
可以看到，要想收集服务端，需要执行的命令很多，为此，专门编写一个脚本来收集服务端信息。
ABS 信息收集脚本 1
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/6.png" alt="图片描述">
ABS 信息收集脚本 2
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/7.png" alt="图片描述">
ABS 信息收集脚本 3
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/8.png" alt="图片描述">
ABS 信息收集脚本 4
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/9.png" alt="图片描述">
ABS 信息收集脚本 5
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/10.png" alt="图片描述">
ABS 信息收集脚本 6
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/11.png" alt="图片描述">
脚本使用说明
A) 命令格式：
...
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/12.png" alt="图片描述">
于是添加-F 参数后，再执行这个命令，会发现这个命令执行的很慢。
对比正常的服务器发现，报错的服务器上缺少如下文件：
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/13.png" alt="图片描述">
...
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/14.png" alt="图片描述">
发现 Context 占了 1GB
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/15.png" alt="图片描述">
发现已经被 disposed 的 SessionContext 有 265 个
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/16.png" alt="图片描述">
由于超时时间未到，未 disposed 的 SessionContext 有 269 个。
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/17.png" alt="图片描述">
...
<p>源码分析
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/18.png" alt="图片描述">
...
下图可能就是这种场景的一个真实写照
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/19.png" alt="图片描述"></p>
<p>三、javacore 分析
通过分析 javacore 文件，发现 process reaper 线程有 27 个之多
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/20.png" alt="图片描述">
初步怀疑是东方通的功能导致的。后续通过多次取 javacore 进行分析。
四、日志分析
在 errorLog.log 日志中，发现记录了大量的 F5 探测报文的日志，将日志记录由 error 改为 debug 即可。
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/AB4.0巡检-徽商银行/21.png" alt="图片描述"></p>

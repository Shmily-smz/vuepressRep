...
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/郑州银行ABC闪退案例/1.png" alt="图片描述">
Jconsole检测内存信息
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/郑州银行ABC闪退案例/2.png" alt="图片描述">
Jconsole检测线程信息
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/郑州银行ABC闪退案例/3.png" alt="图片描述">
Process Explorer检测ABC信息
（2）进行了spy++的信息抓取
闪退时，对ABC主窗口利用spy++抓取信息，筛选完之后有以下指令：
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/郑州银行ABC闪退案例/4.png" alt="图片描述">
...
① Jvm.log 日志显示：
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/郑州银行ABC闪退案例/5.png" alt="图片描述">
...
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/郑州银行ABC闪退案例/6.png" alt="图片描述">
同时，ABC闪退时SPY++监听到输入法消息也恰好验证了闪退时调用了搜狗输入法：
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/郑州银行ABC闪退案例/7.png" alt="图片描述">
③ 进一步统计了，异常日志中JVM崩溃时间和闪退时间，恰好吻合
如20180728 11:49:53
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/郑州银行ABC闪退案例/8.png" alt="图片描述">
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/郑州银行ABC闪退案例/9.png" alt="图片描述">
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/郑州银行ABC闪退案例/10.png" alt="图片描述"></p>
...
<p>相关截图：
<img src="@source/allmd/images/平台/AB4/市场问题处理案例/郑州银行ABC闪退案例/11.png" alt="图片描述"><img src="@source/allmd/images/平台/AB4/市场问题处理案例/郑州银行ABC闪退案例/12.png" alt="图片描述"></p>
<p>Ⅲ、相关问题oracle处理方式

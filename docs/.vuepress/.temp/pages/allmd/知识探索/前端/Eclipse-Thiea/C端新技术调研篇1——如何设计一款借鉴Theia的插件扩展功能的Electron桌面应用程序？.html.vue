...
<img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/1.png" alt="gitpod.png"></li>
...
<img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/2.png" alt="EMF.png"></li>
</ul>
...
<img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/3.png" alt="xmind.png">
...
<img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/4.png" alt="ab-plugin-project.png">
插件工程基于 ts 编写，package.json 中需要通过配置 engine 字段指定当前插件的解析引擎为 AB 插件：<strong>ABPlugin</strong>
<img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/5.png" alt="ab-plugin-package.png">，
插件工程的 src 目录下 index.ts 入口文件内自动生成了生命周期函数<code v-pre>start()</code>和<code v-pre>stop()</code>，入参里传入了一个上下文<code v-pre>context</code>
<img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/6.png" alt="ab-plugin-start.png">
在这里，我们通过 context 中传递过来的 rpc 方法，new 一个<code v-pre>CodecHandler</code>实例。实例的具体实现如下：
<img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/7.png" alt="ab-plugin-codec.png">。
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>调用完成，看看效果：
<img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/8.png" alt="效果.png">
...
<p><img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/9.png" alt="整体架构.png">
...
<p><img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/10.png" alt="process.png">
...
<p><img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/11.png" alt="dispatcher.png">
...
<p><img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/12.png" alt="deploy.png">
...
<p><img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/13.png" alt="management.png">
...
<img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/14.png" alt="theia-plugin-cli.png">
工程目录结构如下，其中有<code v-pre>tsfmt</code>（还未详细看是啥玩意儿。。），插件<code v-pre>src</code>以及<code v-pre>package.json</code>：
<img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/15.png" alt="theia-plugin-project.png">
<code v-pre>package.json</code>中对于一个插件的<code v-pre>engine</code>和入口做了特殊定义：
<img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/16.png" alt="theia-plugin-package.png">
...
<img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/17.png" alt="theia-plugin-start.png">
...
<img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/18.png" alt="ab-plugin-package.png">
下一步，我们就可以直接在源码中书写插件的生命周期函数了。
<img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/19.png" alt="ab-plugin-start.png">
在这里，我们通过 context 中传递过来的 rpc 方法，new 一个<code v-pre>CodecHandler</code>实例。实例的具体实现如下：
<img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/20.png" alt="ab-plugin-codec.png">。
那么，插件内的方法是如何调用的呢？
<img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/21.png" alt="plugin调用.png">
...
至此，插件内方法的调度完成。
话不多说，看看效果：
<img src="@source/allmd/images/知识探索/前端/Eclipse-Thiea/C端新技术调研篇1——如何设计一款借鉴Theia的插件扩展功能的Electron桌面应用程序？/22.png" alt="效果.png"></p>

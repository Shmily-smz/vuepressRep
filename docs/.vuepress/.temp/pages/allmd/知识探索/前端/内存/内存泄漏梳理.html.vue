...
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/1.png" alt="console log leak"></p>
...
<p>通过分析下列内存截图：</p>
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/2.png" alt="leak component"></p>
<p>跳转到对应的视图：</p>
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/3.png" alt="leak component bound fn"></p>
<p>可以通过鼠标hover查看当前组件的信息：</p>
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/4.png" alt="leak component bound this"></p>
<p>通过上述分析，找到对应文件，发现对应代码。原因是使用了<code v-pre>addEventListener</code>但未在组件销毁时进行移除操作。</p>
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/5.png" alt="leak component popover on"></p>
<p><strong>vue @event</strong></p>
<p>在看下面一个内存截图：</p>
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/6.png" alt="vue on leak"></p>
<p>通过右键跳转到对应的位置：</p>
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/7.png" alt="vue on native bind"></p>
<p>根据分析找到对应代码。</p>
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/8.png" alt="vue-on-input"></p>
...
<p>解决方案如下：</p>
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/9.png" alt="vue on resolve"></p>
...
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/10.png" alt="select mutationobserver leak"></p>
<p>通过分析找到源码位置：</p>
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/11.png" alt="select mutationobserver source"></p>
<p>解决方案如下：</p>
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/12.png" alt="select mutationobserver resolve"></p>
...
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/13.png" alt="inject component"></p>
<p>通过鼠标悬浮查看当前组件的信息：</p>
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/14.png" alt="inject component msgbox"></p>
<p>定位源码位置：</p>
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/15.png" alt="inject component msgboxinject"></p>
...
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/16.png" alt="leak auf"></p>
<p><strong>compareData</strong></p>
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/17.png" alt="leak compare 1"></p>
<p>根据上面的经验，查看这个<code v-pre>native_bind</code>的信息：</p>
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/18.png" alt="leak compare 2"></p>
<p><strong>Trade</strong></p>
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/19.png" alt="leak Trade"></p>
<p><strong>listeners</strong></p>
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/20.png" alt="leak listeners 1"></p>
<p>查看这个<code v-pre>listeners</code>所在的对象：</p>
<p><img src="@source/allmd/images/知识探索/前端/内存/内存泄漏梳理/21.png" alt="leak listeners 2"></p>
